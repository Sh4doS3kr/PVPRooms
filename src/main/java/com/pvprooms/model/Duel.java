...
public class Duel {
    ...
    public void    setBo3(boolean bo3)           { this.ranked = bo3; this.winsNeeded = bo3 ? 4 : 1; }

    /** True if the duel has multiple rounds (winsNeeded > 1), regardless of ranked status. */
    public boolean isMultiRound()                { return winsNeeded > 1; }
